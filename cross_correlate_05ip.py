...
def cross_correlate_05ip(input_stis_file):
	...
	'''
	pp = PdfPages('xd_profile_match_05ip.pdf')
	orientat = 52.3642+26.07231253828992  #(WFPC2+STIS/CCD)
	#read in and rotate the WFC3 image
	wfpc2_img = fits.getdata('SN2005ip/wfpc2/hst_10877_61_wfpc2_f675w_wf_drz.fits', 1)  #F814W
...
#		binned_xd_profile = binned_xd_profile + xd_profile[indx::int(binning_factor)]
	...
	wfpc2_x_start = 1320 #2480, 2520
	wfpc2_x_end = 1400
	columns = np.arange(wfpc2_x_start, wfpc2_x_end, stis_slit_width_pix) #Determine which WFC3 columns to cross-correlate stis_slit_width_pix
	corr = []
	offset = []
	wfpc2_y_start = 400 #bottom of the STIS slit
...
if __name__ == "__main__":
	...
	cross_correlate_05ip('SN2005ip/ocdd02090_flt.fits')
